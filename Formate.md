...
For Name(Nithin Joshua J):
(Text that should be big in size near my photo)
...
Below my Name it should display the job role of mine 

After that

Skills(It can be used for the resume in asset file)
...
Now add project page and contact page for placeholder we can do the remaining later

and alse add my photo in the first page which is in asset file